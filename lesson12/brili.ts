...
var numInstrsExecuted: number = 0;
// var maxExecutable: number = 115;
...
function evalInstr(instr: bril.Instruction, state: State): Action {
  ...
  // if ((numInstrsExecuted < maxExecutable) && printTrace) {
  if (printTrace) {
    if (numInstrsExecuted == 0 ){
      console.log("[");
      console.log(instr);
    }
    else {
    ...
    numInstrsExecuted = numInstrsExecuted + 1;
  }
